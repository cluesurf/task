...
export const swift_input_format: List = {
  form: 'list',
  save: '~/code/form/action/compile/code/swift/shared',
  list: ['swift'],
}

const compile_swift_forms = buildCompileForms({
  name: 'compile_swift',
  save: '~/code/form/action/compile/code/swift',
...
export const c_input_format: List = {
  form: 'list',
  save: '~/code/form/action/compile/code/c/shared',
  list: ['c'],
}

const compile_c_forms = buildCompileForms({
  name: 'compile_c',
  save: '~/code/form/action/compile/code/c',
  i: 'c_input_format',
  o: 'backend_compilation_output',
  common: {
    output: {
...
export const cpp_input_format: List = {
  form: 'list',
  save: '~/code/form/action/compile/code/cpp',
  list: ['cpp'],
}
...
export const compile_llvm_ir_to_assembly: Form = {
  form: 'form',
  save: '~/code/form/action/compile/code/llvm-ir',
  link: {
    input: {
      link: {
...
export const compile_java: Form = {
  form: 'form',
  save: '~/code/form/action/compile/code/java',
  link: {
    input: {
      link: {
        format: { like: 'string' },
...
const compile_rust_forms = buildCompileForms({
  name: 'compile_rust',
  save: '~/code/form/action/compile/code/rust',
  i: 'rust_input_format',
...
export const wast_input_format: List = {
  form: 'list',
  save: '~/code/form/action/compile/code/wast/shared',
  list: ['wast'],
}
...
const compile_wast_forms = buildCompileForms({
  name: 'compile_wast',
  save: '~/code/form/action/compile/code/wast',
  i: 'wast_input_format',
...
export const compile_llvm: Form = {
  form: 'form',
  save: '~/code/form/action/compile/code/llvm/shared',
  link: {
    input: {
      link: {
        format: { like: 'string' },
...
export const compile_asm: Form = {
  form: 'form',
  save: '~/code/form/action/compile/code/asm/shared',
  link: {
    input: {
      link: {
        format: { like: 'string' },
...
export const resolve_input_for_compile_remote: Form = {
  form: 'form',
  save: '~/code/form/action/compile/code',
