...
/**
 * Browser entrypoint for `task encrypt`. Forwards the input
 * (file content + fields) to a task-compatible host on the
 * `/encrypt!` route. The server reconstructs the input from
...
export default encryptBrowser
export { encryptBrowser }
