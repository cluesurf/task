...
/**
 * Browser entrypoint for `task inspect`. Forwards the input
 * (file content + fields) to a task-compatible host on the
 * `/inspect!` route. The server reconstructs the input from
...
export default inspectBrowser
export { inspectBrowser }
