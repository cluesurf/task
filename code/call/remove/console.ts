...
registerGroupHelp({
  ...
  commands: [
    ...
    { name: 'subtitles',    describe: 'Drop subtitle streams from a video' },
    { name: 'metadata',     describe: 'Strip all EXIF / XMP / ID3 metadata' },
    { name: 'exif',         describe: 'Strip specific EXIF tags (surgical)' },
    { name: 'password',     describe: 'Strip a password from a PDF' },
    { name: 'profile',      describe: 'Strip embedded ICC / IPTC / XMP profiles' },
    { name: 'transparency', describe: 'Flatten alpha onto a solid background' },
    { name: 'invisible',    describe: 'Strip zero-width / BOM / invisible chars' },
