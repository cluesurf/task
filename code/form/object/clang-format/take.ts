...
export const ClangStyleAllParser = z.object({
  ...
  breakInheritanceList: z.optional(
    z.enum(['beforeColon', 'beforeComma', 'afterColon', 'afterComma']),
  ),
  ...
  requiresClausePosition: z.optional(
    z.enum(['ownLine', 'withPreceding', 'withFollowing', 'singleLine']),
  ),
...
export type ClangStyleJavascriptRecord = z.infer<
