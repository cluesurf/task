...
} from '~/code/type/action/format/code/browser/index'
import {
  FileContentParser,
  FileContentWithSha256Parser,
} from '~/code/type/object/file/parsers'
import { ClangStyleAllParser } from '~/code/type/object/clang-format/parsers'
import { ClangFormatParser } from '~/code/type/action/format/code/shared/parsers'
