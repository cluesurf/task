...
```sh
make/deck/linux/docker-build.sh alpine
```
...
```sh
echo https://deck.clue.surf/task/apk | doas tee -a /etc/apk/repositories
doas wget -O /etc/apk/keys/cluesurf.rsa.pub https://deck.clue.surf/task/apk/cluesurf.rsa.pub
